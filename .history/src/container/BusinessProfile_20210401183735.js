    ...
    render() {
        return (
            <div className="businessPage" >
                ...
                <div>
                    <form className="ui form" id="reviewForm" onSubmit={(e) => this.props.handleSubmitReview(e)} onSubmit={(e) => this.props.handleSubmitReviewBusiness(e, this.props.business.id)}>
                        <br/>
